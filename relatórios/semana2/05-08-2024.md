...
1. **[Modelagem de Dados]:** Modelagem de dados é o processo de desenvolver um modelo que ilustra como os diferentes tipos de dados funcionam em um sistema de informação. Para garantir que os dados sejam organizados, acessíveis e manipuláveis de forma eficiente e consistente, ele inclui modelos conceituals, lógicos e físicos. 
